RecipeIngredientsController < ApplicationController
  def index
  ...
  def create
    @recipe_ingredient = RecipeIngredient.new(params.require(:recipe_ingredient).permit(:name, :creator, :cooktime, :cooktemp, :difficulty, :directions, :type))
